...
| File | Answers |
|---|---|
| [`RUNTIME-AGENT.md`](./RUNTIME-AGENT.md) | How to turn intent into `runtime` requests (discover → validate → plan → explicit execute) |
...
[`RUNTIME-AGENT.md`](../../RUNTIME-AGENT.md). Read the third before authoring a capability —
